<template>
  ...
  >
    ...
    <div v-if="currentStep === 1 && showForm" class="w-full relative">
      ...
      >
        <p class="mb-4 text-[25px] text-gray-700">
          Applicants Name (Corporation or Individual)
        </p>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.applicant.premises_address"
            type="text"
          ...
          />
          <label
            for="premises_address"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Premises Address</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.applicant.required_date"
            type="date"
            name="required_date"
            id="required_date"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.applicant.unit_type"
            type="text"
            name="unit_type"
            id="unit_type"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.applicant.business_name"
            type="text"
            name="business_name"
            id="business_name"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.applicant.business_type"
            type="text"
            name="business_type"
            id="business_type"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.applicant.business_duration"
            type="text"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.guarantor.driver_license_number"
            type="text"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.guarantor.phone_number"
            type="tel"
            name="phone_number"
            id="phone_number"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.guarantor.previous_address"
            type="text"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.guarantor.duration_at_previous_address"
            type="text"
            name="duration_at_previous_address"
            id="duration_at_previous_address"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            placeholder=" "
            required
          />
          <label
            for="duration_at_previous_address"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Duration at Previous Address</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.guarantor.ownership_status"
            type="text"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <p
            class="text-sm text-gray-900 bg-transparent appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
          >
            Have you ever been evicted from a property?
          </p>
          <input
            v-model="form.guarantor.eviction_history"
            type="radio"
            name="eviction_history"
            id="eviction_history_yes"
            value="Yes"
            required
            style="margin-top: 10px"
          />
          <label
            for="eviction_history_yes"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            >Yes</label
          >
          <input
            v-model="form.guarantor.eviction_history"
            type="radio"
            name="eviction_history"
            id="eviction_history_no"
            value="No"
            required
            style="margin-top: 10px"
          />
          <label
            for="eviction_history_no"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            >No</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          ...
          <input
            v-model="form.guarantor.bankruptcy_history"
            type="radio"
            name="bankruptcy_history"
            id="bankruptcy_history_yes"
            value="Yes"
            required
          />
          <label
            for="bankruptcy_history_yes"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            >Yes</label
          >
          <input
            ...
            type="radio"
            name="bankruptcy_history"
            id="bankruptcy_history_no"
            value="No"
            required
          />
          <label
            for="bankruptcy_history_no"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            >No</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.guarantor.emergency_contact.name"
            type="text"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.guarantor.emergency_contact.phone_number"
            type="tel"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.guarantor.emergency_contact.email"
            type="email"
    ...
    <div v-if="currentStep === 2 && showForm" class="w-full relative">
      ...
      >
        <p class="mb-4 text-[20px] text-gray-700">
          Information Needed for Credit Check
        </p>

        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.credit_check.applicant_birth_date"
            type="date"
          ...
          />
          <label
            for="applicant_birth_date"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Applicant’s Birth Date</label
          >
        </div>

        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.credit_check.social_insurance_number"
            type="text"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.name"
            type="text"
          ...
          />
          <label
            for="co_applicant_name"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Legal Name</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.driver_license_number"
            type="text"
            name="co_applicant_driver_license_number"
            id="co_applicant_driver_license_number"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            placeholder=" "
            required
          />
          <label
            for="co_applicant_driver_license_number"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's DriverLicense Number</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.phone_number"
            type="tel"
          ...
          />
          <label
            for="co_applicant_phone_number"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Phone Number</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.email"
            type="email"
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.previous_address"
            type="text"
            name="co_applicant_previous_address"
            id="co_applicant_previous_address"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            placeholder=" "
            required
          />
          <label
            for="co_applicant_previous_address"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Previous Address</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.duration_at_previous_address"
            type="text"
            name="co_applicant_duration_at_previous_address"
            id="co_applicant_duration_at_previous_address"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            placeholder=" "
            required
          />
          <label
            for="co_applicant_duration_at_previous_address"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Duration at Previous Address</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.ownership_status"
            type="text"
            name="co_applicant_ownership_status"
            id="co_applicant_ownership_status"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            placeholder=" "
            required
          />
          <label
            for="co_applicant_ownership_status"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Ownership Status</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          ...
          <input
            v-model="form.co_applicant.eviction_history"
            type="radio"
            name="co_applicant_eviction_history"
            id="co_applicant_eviction_history_yes"
            value="Yes"
            required
          />
          <label
            for="co_applicant_eviction_history_yes"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            >Yes</label
          >
          ...
          <input
            ...
            type="radio"
            name="co_applicant_eviction_history"
            id="co_applicant_eviction_history_no"
            value="No"
            required
          />
          <label
            for="co_applicant_eviction_history_no"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            >No</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          ...
          <input
            v-model="form.co_applicant.bankruptcy_history"
            type="radio"
            name="co_applicant_bankruptcy_history"
            id="co_applicant_bankruptcy_history_yes"
            value="Yes"
            required
          />
          <label
            for="co_applicant_bankruptcy_history_yes"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            >Yes</label
          >
          ...
          <input
            ...
            type="radio"
            name="co_applicant_bankruptcy_history"
            id="co_applicant_bankruptcy_history_no"
            value="No"
            required
          />
          <label
            for="co_applicant_bankruptcy_history_no"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            >No</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.emergency_contact.name"
            type="text"
            name="co_applicant_emergency_contact_name"
          ...
          />
          <label
            for="co_applicant_emergency_contact_name"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Emergency Contact Name</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.emergency_contact.phone_number"
            type="tel"
            name="co_applicant_emergency_contact_phone"
            id="co_applicant_emergency_contact_phone"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            placeholder=" "
            required
          />
          <label
            for="co_applicant_emergency_contact_phone"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Emergency Contact Phone</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.emergency_contact.email"
            type="email"
            name="co_applicant_emergency_contact_email"
            id="co_applicant_emergency_contact_email"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            placeholder=" "
            required
          />
          <label
            for="co_applicant_emergency_contact_email"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Emergency Contact Email</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.birth_date"
            type="date"
            name="co_applicant_birth_date"
            id="co_applicant_birth_date"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            required
          />
          <label
            for="co_applicant_birth_date"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Birth Date</label
          >
        </div>
        ...
        <div class="relative z-0 w-full mb-4 group">
          <input
            v-model="form.co_applicant.social_insurance_number"
            type="text"
            name="co_applicant_social_insurance_number"
            id="co_applicant_social_insurance_number"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer"
            placeholder=" "
            required
          />
          <label
            for="co_applicant_social_insurance_number"
            class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Co-Applicant's Social Insurance Number</label
          >
        </div>

        <p class="mb-4 text-[20px] text-gray-700">
          References (Business, Bank, Client or Supplier)
        </p>
...
export default {
  ...
  methods: {
      ...
      for (const key in data) {
        if (Object.hasOwnProperty.call(data, key)) {
          ...
          fullKey = fullKey.replace(
            "applicant.premises_address",
            "Address of Premises to be Rented"
          );
          fullKey = fullKey.replace(
            "applicant.required_date",
          ...
          fullKey = fullKey.replace(
            "guarantor.driver_license_number",
            "Driver's License Number"
          );
          fullKey = fullKey.replace("guarantor.phone_number", "Phone Number");
          fullKey = fullKey.replace("guarantor.email", "Email");
          fullKey = fullKey.replace(
            "guarantor.previous_address",
            "Previous Address"
          );
          fullKey = fullKey.replace(
            "guarantor.duration_at_previous_address",
            "Duration at Previous Address"
          );
          fullKey = fullKey.replace(
            "guarantor.ownership_status",
            "Ownership Status"
          );
          fullKey = fullKey.replace(
            "guarantor.eviction_history",
            "Eviction History"
          );
          fullKey = fullKey.replace(
            "guarantor.bankruptcy_history",
            "Bankruptcy History"
          );
          fullKey = fullKey.replace(
            "guarantor.emergency_contact.name",
            "Emergency Contact Name"
          );
          fullKey = fullKey.replace(
            "guarantor.emergency_contact.phone_number",
            "Emergency Contact Phone Number"
          );
          fullKey = fullKey.replace(
            "guarantor.emergency_contact.email",
            "Emergency Contact Email"
          );

          // Credit Check
          fullKey = fullKey.replace(
            "credit_check.applicant_birth_date",
            "Applicant's Birth Date"
          );
          fullKey = fullKey.replace(
            "credit_check.social_insurance_number",
          ...
          fullKey = fullKey.replace(
            "co_applicant.driver_license_number",
          ...
          fullKey = fullKey.replace(
            "co_applicant.previous_address",
            "Co-Applicant Previous Address"
          );
          fullKey = fullKey.replace(
            "co_applicant.duration_at_previous_address",
            "Co-Applicant Duration at Previous Address"
          );
          fullKey = fullKey.replace(
            "co_applicant.ownership_status",
            "Co-Applicant Ownership Status"
          );
          fullKey = fullKey.replace(
            "co_applicant.eviction_history",
            "Co-Applicant Eviction History"
          );
          fullKey = fullKey.replace(
            "co_applicant.bankruptcy_history",
            "Co-Applicant Bankruptcy History"
          );
          fullKey = fullKey.replace(
            "co_applicant.emergency_contact.name",
            "Co-Applicant Emergency Contact Name"
          );
          fullKey = fullKey.replace(
            "co_applicant.emergency_contact.phone_number",
            "Co-Applicant Emergency Contact Phone Number"
          );
          fullKey = fullKey.replace(
            "co_applicant.emergency_contact.email",
            "Co-Applicant Emergency Contact Email"
          );
          fullKey = fullKey.replace(
            "co_applicant.birth_date",
            "Co-Applicant Birth Date"
          );
          fullKey = fullKey.replace(
            "co_applicant.social_insurance_number",
            "Co-Applicant Social Insurance Number"
          );
    ...
    async sendEmail() {
      ...
      // create File object
      const pdfFile = new File([pdfBlob], `${this.form.applicant.name}.pdf`, {
