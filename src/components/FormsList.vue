    ...
    >
        <div v-if="currentStep === 1 && showForm" class="w-full relative">
            ...
            >
                ...
                <!-- Employer Name Field -->
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant1.employer_name" type="text" name="employer_name" id="applicant1_employer_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant1.supervisor_name" type="text" name="supervisor_name" id="applicant1_supervisor_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <!-- Job Title Field -->
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant1.job_title" type="text" name="job_title" id="applicant1_job_title" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant1.employer_phone" type="tel" name="employer_phone" id="applicant1_employer_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <!-- Employer Name Field -->
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant2.employer_name" type="text" name="employer_name" id="applicant2_employer_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <!-- Supervisor Name Field -->
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant2.supervisor_name" type="text" name="supervisor_name" id="applicant2_supervisor_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <!-- Job Title Field -->
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant2.job_title" type="text" name="job_title" id="applicant2_job_title" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    <label for="applicant2_job_title" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" >Job Title</label>
                </div>

                <!-- Employer Phone Field -->
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant2.employer_phone" type="tel" name="employer_phone" id="applicant2_employer_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
        ...
        <div v-if="currentStep === 4 && showForm" class="w-full relative">
            ...
            >
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.other_income_sources.type_of_income" type="text" name="type_of_income" id="type_of_income" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div v-for="(vehicle, index) in form.vehicles" :key="index">
                    ...
                    <!-- Year Field -->
                    <div class="relative z-0 w-full mb-4 group">
                        <input v-model="vehicle.year" type="text" :name="`vehicle_year_${index}`" :id="`vehicle_year_${index}`" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    ...
                    <!-- Make Field -->
                    <div class="relative z-0 w-full mb-4 group">
                        <input v-model="vehicle.make" type="text" :name="`vehicle_make_${index}`" :id="`vehicle_make_${index}`" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    ...
                    <!-- Model Field -->
                    <div class="relative z-0 w-full mb-4 group">
                        <input v-model="vehicle.model" type="text" :name="`vehicle_model_${index}`" :id="`vehicle_model_${index}`" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    ...
                    <!-- Plate Number Field -->
                    <div class="relative z-0 w-full mb-4 group">
                        <input v-model="vehicle.plate_number" type="text" :name="`vehicle_plate_number_${index}`" :id="`vehicle_plate_number_${index}`" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.banking_information.banking_institution" type="text" name="banking_institution" id="banking_institution" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    <label for="banking_institution" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" >Banking Institution</label>
                </div>

                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.banking_information.address" type="text" name="banking_address" id="banking_address" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    <label for="banking_address" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" >Banking Address</label>
                </div>

                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.banking_information.phone" type="tel" name="banking_phone" id="banking_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.references[0].address" type="text" name="reference_name" id="reference_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.references[0].phone_number" type="text" name="reference_name" id="reference_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.references[0].relationship" type="text" name="reference_relationship" id="reference_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.references[1].address" type="text" name="reference_name" id="reference_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    <label for="reference_name" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" >Reference Address</label>
                </div>
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.references[1].phone_number" type="text" name="reference_name" id="reference_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    <label for="reference_name" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" >Reference Phone Number</label>
                </div>
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.references[1].relationship" type="text" name="reference_relationship" id="reference_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    <label for="reference_name" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" >Reference Relationship</label>
                </div>
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant1_signature" type="text" name="applicant1_signature" id="applicant1_signature" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    <label for="applicant1_signature" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" >Applicant 1 Signature</label>
                </div>

                <!-- Applicant 2 Signature Field -->
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.applicant2_signature" type="text" name="applicant2_signature" id="applicant2_signature" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                    <label for="applicant2_signature" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin- peer-focus:left-0 peer-focus:text-teal peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" >Applicant 2 Signature</label>
                </div>

                <!-- Witness Name Field -->
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.witness_name" type="text" name="witness_name" id="witness_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input v-model="form.witness_signature" type="text" name="witness_signature" id="witness_signature" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-teal appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" placeholder=" " required />
