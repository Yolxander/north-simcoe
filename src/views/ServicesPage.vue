<template>
    ...
    <ServiceCard :services="services"/> <!-- Here's the change -->
    <ContactUs/>
</template>
        ...
        return {
            ...
            services: [
...

                {
                    ...
                    text: 'Maintaining a property in top-notch condition is crucial for its value preservation and the satisfaction of its tenants. At North Simcoe Property Management, we offer Full Property Maintenance services to alleviate property owners from the hassles associated with property upkeep. ' +
                    ...
                    updatedAt: 'Last updated 1 hour ago',
                }
            ]
