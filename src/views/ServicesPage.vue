    ...
    return {
      ...
      services: [
        ...
        },
        {
          ...
          paragraph: [
            "We know that each property is unique. Our team carefully reviews your property and offers custom pricing, so you get the best ROI.",
          ],
          paragraphEnd:
            "Ready to work with our team? Fill out a form below or reach out at",
          phone: "+1 (647) 500-1747",
      ...
      intro: [
        {
          ...
          textleft:
            "We at Noth Simcoe have many reasons why we differ from the rest. We offer custom pricing, free legal advice when it comes to the landlord tenant board, as well as no charge for filing any forms and starting the process to get a court date.",
          textrightP1:
